...
<body>
    ...
    <section>
        <div>
            <ul>
                <li>
                    <img class="mejora_imagen" src="img/africa.jpg" alt="Europa">
                    <div class="info_textos">
                        <h1 class="texto_europa">Aventuras y Naturaleza</h1>
                    </div>
                </li>
            </ul>
    </section>
    <section id="islaPascua">
        ...
        @foreach ($aventuras as $aventura)
            ...
            <div class="imagen">
                <img src="{{ asset('img/' . $aventura->imagen) }}" alt="{{ $aventura->titulo }}">
            </div>
