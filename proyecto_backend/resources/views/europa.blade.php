...
<body>
    ...
    <section>
        <div>
            <ul>
                <li>
                    <img class="mejora_imagen" src="img/atenas.jpg" alt="Europa">
                    <div class="info_textos">
                        <h1 class="texto_europa">Destinos en el Mundo</h1>
                    </div>
                </li>
            </ul>
    </section>
    ...
    <section id="islaPascua">
        ...
        @foreach ($continentes as $continente)
            ...
            <div class="imagen">
                <img src="{{ asset('img/' . $continente->imagen) }}" alt="{{ $continente->titulo }}">
            </div>
                <h3>{{ $continente->titulo }}</h3>
